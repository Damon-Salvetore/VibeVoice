...
> - The model will be downloaded to `/app/models/VibeVoice-ASR` inside the container
...
```bash
# Copy your audio file to the VibeVoice directory first
cp /path/to/audio.wav ./
